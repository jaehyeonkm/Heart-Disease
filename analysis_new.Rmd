...
There are 4 different models made: decision tree, knn, booste model, and random forest model. The training data is split further into estimation and validation data in order to calculate the validation accuracy of each model. Cross-validation using 5 folds is used for each of the model. 
